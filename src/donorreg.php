        ...
        <section class="signup">
            ...
            <div class="container">
                <div class="signup-content">
                    <form action="donorreg1.php" method="POST" id="signup-form" class="regform">
                        <h2 class="form-title">Donor Registration</h2>
                        <div class="form-group">
                            <input type="text" class="form-input" name="d_id" id="d_id" maxlength="12" minlength="12" placeholder="Aadhaar Id" autocomplete="off" />
                        </div>
                        <div class="form-group">
                            <input type="text" class="form-input" name="name" id="name" placeholder="Your Name" autocomplete="off" />
                        </div>
                        <div class="form-group">
                            <input type="Text" class="form-input" name="blood_group" id="blood group" placeholder="Your Blood Group" autocomplete="off"/>
                        </div>
                        <div class="form-group">
